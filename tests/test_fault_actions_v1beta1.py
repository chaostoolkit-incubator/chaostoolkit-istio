...
def test_add_fault_if_route_matches(client, get_vs):
    ...
    res = set_fault("mysvc", routes, fault, ns="default", version="networking.istio.io/v1beta1")
...
def test_remove_fault_if_route_matches(client, get_vs):
    ...
    res = unset_fault("mysvc", routes, ns="default", version="networking.istio.io/v1beta1")
    call_api.assert_called_with(
        "/apis/networking.istio.io/v1beta1/namespaces/default/virtualservices/mysvc",
        "PATCH",
        header_params={
...
def test_add_delay_fault(client, get_vs):
    ...
    res = add_delay_fault("mysvc", "5s", routes, percentage=100.0, ns="default", version="networking.istio.io/v1beta1")
    call_api.assert_called_with(
        "/apis/networking.istio.io/v1beta1/namespaces/default/virtualservices/mysvc",
        "PATCH",
        header_params={
...
def test_add_abort_fault(client, get_vs):
    ...
    res = add_abort_fault("mysvc", 404, routes, percentage=100.0, ns="default", version="networking.istio.io/v1beta1")
    call_api.assert_called_with(
        "/apis/networking.istio.io/v1beta1/namespaces/default/virtualservices/mysvc",
        "PATCH",
        header_params={
